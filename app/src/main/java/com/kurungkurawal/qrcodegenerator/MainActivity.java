...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText txtQRText1;
    private EditText txtQRText2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtQRText1   = (EditText)findViewById(R.id.txtQR1);
        txtQRText2   = (EditText)findViewById(R.id.txtQR2);
        ...
        txtQRText1.setText("hello");
        txtQRText2.setText("hello");
    ...
    private void endEditing(){
        txtQRText1.clearFocus();
        txtQRText2.clearFocus();
    ...
    private void generateImage(){
        final String text = txtQRText1.getText().toString() + ";" + txtQRText2.getText().toString();
